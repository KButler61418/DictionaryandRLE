...
public class DictionaryEncoding {
    ...
    public static void main(String[] args) {
        ...
        HashMap<String, Integer> dictionary = new HashMap<>(); //Couldn't understand how to code it myself so used a possible solution
        // I now understand it a little better than before by changing different parts of the code to see what happened
